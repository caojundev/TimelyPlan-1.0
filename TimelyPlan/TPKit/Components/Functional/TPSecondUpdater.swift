...
/// 秒级更新器
/// 与 `TPMinuteUpdater` 类似，按秒对齐触发更新，并在前后台切换时自动启停
class TPSecondUpdater {
    ...
    private func startTimer() {
        ...
        // 对齐到下一秒
        let interval = 1.0 - Date().timeIntervalSince1970.truncatingRemainder(dividingBy: 1.0)
        ...
        newTimer.schedule(deadline: .now() + interval, repeating: 1.0)
