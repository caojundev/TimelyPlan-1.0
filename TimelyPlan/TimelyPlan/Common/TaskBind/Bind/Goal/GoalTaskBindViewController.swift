//
//  GoalTaskBindViewController.swift
//  TimelyPlan
//
...
class GoalTaskBindViewController: TPViewController,
    ...
    func groupTableView(_ tableView: TPGroupTableView, didDequeCell cell: UITableViewCell, at indexPath: IndexPath) {
        let cell = cell as! GoalTaskBindCell
...
extension GoalTaskBindViewController: GoalPlanProcessorDelegate {
...
extension GoalTaskBindViewController: GoalTaskProcessorDelegate {
