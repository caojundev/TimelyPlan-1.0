...
class FocusTimerEditViewController: TPTableSectionsViewController {
    ...
    lazy var scheduleSectionController: FocusTimerScheduleEditSectionController = { [weak self] in
        ...
        sectionController.timePlan = editingTimer.timePlan ?? TaskTimePlanRegularRule()
        ...
        sectionController.timePlanDidChange = { timePlan in
            self?.editingTimer.timePlan = timePlan
        }
