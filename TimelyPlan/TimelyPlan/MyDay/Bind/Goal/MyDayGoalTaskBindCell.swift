...
class MyDayGoalTaskBindCell: TPBaseTableCell, SearchHighlightable {
    ...
    func updateInfo() {
        ...
        /// 详情
        let option: GoalTaskDetailOption = [.myDay, .schedule, .progress, .weight]
